package cl.tenpo.evaluation.authservice;
...
class AuthServiceIntegrationTests {
    ...
    void signin_without_authentication_header_should_throw_401() throws Exception{
        this.mvc.perform(
                MockMvcRequestBuilders.post("/api/v1/auth/signin")
                    ...
                    .content(this.objectMapper.writeValueAsString(LoginRequest.builder().username("user").password("1234").build())))
    ...
    void signin_should_return_access_token() throws Exception{
        ...
        this.mvc.perform(
                MockMvcRequestBuilders.post("/api/v1/auth/signin")
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(this.objectMapper.writeValueAsString(LoginRequest.builder().username(username).password(password).build())))
            .andExpect(MockMvcResultMatchers.status().is(200))
